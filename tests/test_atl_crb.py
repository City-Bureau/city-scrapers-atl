...
def test_description(item):
    assert (
        item["description"]
        == "The ACRB usually meets every second Thursday of each month at 6:30 p.m."
        + " at Atlanta City Hall, 55 Trinity Avenue, SW, Second Floor,"
...
def test_location(item):
    assert item["location"] == {
        ...
        "address": "55 Trinity Avenue SW, Second Floor Atrium, Committee Room One,"
        + " Atlanta, GA 30303",
    }
